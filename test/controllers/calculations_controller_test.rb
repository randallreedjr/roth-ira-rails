...
class CalculationsControllerTest < ActionController::TestCase
  ...
  test "should create calculation" do
    assert_difference('Calculation.count') do
      post :create, calculation: { age: @calculation.age, filing_status: @calculation.filing_status, magi: @calculation.magi, spouse_age: @calculation.spouse_age }
    end
  ...
  test "should update calculation" do
    patch :update, id: @calculation, calculation: { age: @calculation.age, filing_status: @calculation.filing_status, magi: @calculation.magi, spouse_age: @calculation.spouse_age }
    assert_redirected_to calculation_path(assigns(:calculation))
  end
